...
class base58:
    ...
    def b58encode(
        ...
        result = base58.b58encode_int(acc, default_one=False, alphabet=alphabet)
    ...
    def b58decode(
        ...
        acc = base58.b58decode_int(v, alphabet=alphabet, autofix=autofix)
    ...
    def b58encode_check(
        ...
        return base58.b58encode(v + digest[:4], alphabet=alphabet)
    ...
    def b58decode_check(
        ...
        result = base58.b58decode(v, alphabet=alphabet, autofix=autofix)
